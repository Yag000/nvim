require("presence").setup({
    ...
    neovim_image_text   = "The One Editor To Rule Them All", -- Text displayed when hovered over the Neovim image
    ...
    workspace_text      = ":)",                 -- Format string rendered when no file is loaded in the buffer (either string or function(workspace_name: string): string)
